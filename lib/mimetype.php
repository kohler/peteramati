...
class Mimetype {
    ...
    private static $tinfo = [
        self::TXT_TYPE =>     [1, ".txt", "text", self::FLAG_INLINE],
        self::PDF_TYPE =>     [2, ".pdf", "PDF", self::FLAG_INLINE],
        self::PS_TYPE =>      [3, ".ps", "PostScript", 0],
        self::PPT_TYPE =>     [4, ".ppt", "PowerPoint", 0, "application/mspowerpoint", "application/powerpoint", "application/x-mspowerpoint"],
        "application/vnd.openxmlformats-officedocument.presentationml.presentation" =>
                              [5, ".pptx", "PowerPoint", 0],
        "video/mp4" =>        [6, ".mp4", null, 0],
        "video/x-msvideo" =>  [7, ".avi", null, 0],
        self::JSON_TYPE =>    [8, ".json", "JSON", self::FLAG_UTF8],
        self::JPG_TYPE =>     [9, ".jpg", "JPEG", self::FLAG_INLINE, ".jpeg"],
        self::PNG_TYPE =>     [10, ".png", "PNG", self::FLAG_INLINE]
    ];
    ...
    static function lookup($type, $nocreate = false) {
        ...
        if (empty(self::$tmap))
            foreach (self::$tinfo as $xtype => $data) {
                $m = new Mimetype($xtype, $data[1], $data[0], $data[2], $data[3]);
